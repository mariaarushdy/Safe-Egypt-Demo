...
const translations = {
  ar: {
    ...
    'settings.passwordWeak': 'كلمة المرور ضعيفة. يرجى استيفاء جميع المتطلبات أدناه.',
    'settings.passwordReq8Chars': 'على الأقل 8 أحرف',
    'settings.passwordReqLowercase': 'حرف صغير واحد على الأقل',
    'settings.passwordReqUppercase': 'حرف كبير واحد على الأقل',
    'settings.passwordReqNumber': 'رقم واحد على الأقل',
    'settings.passwordReqSpecial': 'رمز خاص واحد على الأقل',
    'settings.passwordRequirements': 'متطلبات كلمة المرور',
    'settings.failedToAddUser': 'فشل في إضافة المستخدم',
    'settings.failedToUpdateUser': 'فشل في تحديث المستخدم',
    'settings.failedToDeleteUser': 'فشل في حذف المستخدم',
    'settings.userCreatedSuccess': 'تم إنشاء المستخدم بنجاح',
    'settings.userUpdatedSuccess': 'تم تحديث المستخدم بنجاح',
