...
def test_auth_system():
    ...
    # Test 1: Verify default admin exists (dashboard_users)
    print("\n[Test 1] Verifying default admin user in dashboard_users...")
    try:
        admin = user_service.authenticate_user("admin", "Admin@123")
        if admin:
            ...
            print(f"   Last Login: {admin.get('last_login', 'N/A')}")
        else:
